...
public:
	...
	void setProjectionSize(const ProjectionSize& dimension);
	ProjectionSize getProjectionSize();

	void setProjectionRestraint(const ProjectionDirectionRestraint& range);
	ProjectionDirectionRestraint getProjectionDirectionRestraint();
