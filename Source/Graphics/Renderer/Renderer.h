...
public:
	...
	void setNdcMatrix(const Mat4& matrix);
	Mat4 getNdcMatrix();

	void setProjectionRange(const ProjectionRange& range);
	ProjectionRange getProjectionRange();
	...
	void draw(Bvh* bvh, VisualEffect* visualEffect, VisualMaterial* visualMaterial, const Mat4& worldMatrix, const Mat4& viewMatrix, const Mat4& viewProjectionMatrix, const Vec3& lightCoefficients, const Vec3& lightColor, const Vec3& lightPosition, const Vec3& eyePosition);
	void draw(Octree* octree, VisualEffect* visualEffect, VisualMaterial* visualMaterial, const Mat4& worldMatrix, const Mat4& viewMatrix, const Mat4& viewProjectionMatrix, const Vec3& lightCoefficients, const Vec3& lightColor, const Vec3& lightPosition, const Vec3& eyePosition);
	...
	virtual SpatialBoundVisual3* createVisualSpatial(const Mesh& mesh, const Material& material) = 0;
	virtual VisualEffect* createVisualEffect(const Effect& effect) = 0;
	virtual void draw(SpatialBoundVisual3* visual, VisualEffect* visualEffect, const Vec3& eyePosition, const std::vector<SpatialLight*>& spatialLights) = 0;
	...
	virtual void draw(const Bound3& bound, VisualEffect* visualEffect, VisualMaterial* visualMaterial, const Mat4& worldMatrix, const Mat4& viewMatrix, const Mat4& viewProjectionMatrix, const Vec3& lightCoefficients, const Vec3& lightColor, const Vec3& lightPosition, const Vec3& eyePosition) = 0;
