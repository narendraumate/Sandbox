...
Mat3 Mat3::inverse() const {
	return Mat3(+d[1][1] * d[2][2] - d[1][2] * d[2][1], -d[0][1] * d[2][2] - d[0][2] * d[2][1], +d[0][1] * d[1][2] - d[0][2] * d[1][1],
			   -d[1][0] * d[2][2] - d[1][2] * d[2][0], +d[0][0] * d[2][2] - d[0][2] * d[2][0], -d[0][0] * d[1][2] - d[0][2] * d[1][0],
			   +d[1][0] * d[2][1] - d[1][1] * d[2][0], -d[0][0] * d[2][1] - d[0][1] * d[2][0], +d[0][0] * d[1][1] - d[0][1] * d[1][0])
		/ determinant();
}
...
Mat3 Mat3::noscaleinverse() const {
	...
	Vec2 newt = (oldr.transpose() * oldt) * -1.0f;
