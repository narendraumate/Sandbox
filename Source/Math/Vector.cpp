...
bool almostEqual(const Vec1& u, const Vec1& v) {
	return almostEquals(u.x, v.x);
}

bool almostEqual(const Vec2& u, const Vec2& v) {
	return almostEquals(u.x, v.x) && almostEquals(u.y, v.y);
}

bool almostEqual(const Vec3& u, const Vec3& v) {
	return almostEquals(u.x, v.x) && almostEquals(u.y, v.y) && almostEquals(u.z, v.z);
}

bool almostEqual(const Vec4& u, const Vec4& v) {
